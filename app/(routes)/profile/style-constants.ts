export const styles = {
  ...
  bulletList: "mt-1 space-y-1 text-sm text-zinc-700",
  primaryButtonAlt:
  ...
  cancelButton:
    "rounded-full border border-zinc-200 px-4 py-2 text-sm font-semibold text-zinc-800 transition hover:bg-indigo-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--accent)]",
  categoryCard:
    "rounded-xl border border-indigo-100 bg-gradient-to-r from-white via-[#f3f1ff] to-white shadow-sm",
  itemCard:
    "rounded-xl border border-zinc-100 bg-zinc-50 p-4 flex items-start justify-between gap-3",
  formField: "space-y-1 block",
  formSection: "space-y-2",
  sectionCard: "space-y-2 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-zinc-100",
  sectionBody: "space-y-2 text-sm text-zinc-700",
  stackMd: "space-y-3",
  sectionCardMd:
  ...
  bodyText: "text-sm text-zinc-700",
  ...
  input: "w-full rounded border border-zinc-200 px-3 py-2",
  addButton:
